...
f2 = os.path.join(sourceFileDir, 'static/green1.png')
f3 = os.path.join(sourceFileDir, 'static/fire1.png')
f4 = os.path.join(sourceFileDir, 'static/high.png')
f5 = os.path.join(sourceFileDir, 'static/robo1.png')
boardImg = pygame.image.load(fondImgPath)
leafImg = pygame.image.load(f2)
fireImg = pygame.image.load(f3)
highImg = pygame.image.load(f4)
roboImg = pygame.image.load(f5)
